...
INSERT INTO ecommerce.tb_user (full_name, login, password, expires_at, subject, fk_group_id)
VALUES('Alex Verstappen', 'jun1@jun.com', crypt('Junit@123', gen_salt('bf', 12)), current_timestamp + interval '2 years', '35f5afb1-c754-4038-9631-b04075480b5c', (SELECT id FROM ecommerce.tb_group WHERE group_acronym='CONSUMER'));